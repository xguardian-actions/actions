...
Executa análise estática de código-fonte (SAST) e análise de composição de software (SCA) com um único upload de ZIP.
...
|-------|--------|-----------|
| `sast` | `"true"` | Ativa análise estática de código |
| `sca` | `"true"` | Ativa análise de dependências |
